    ...
    <div class="wrapper">
        ...
        <div class="content">
            <div class="selects">
                ...
                <select :disabled="!selectedCategory" v-model="selectedProduct">
                    <option v-if="!selectedCategory" disabled value="">請先選擇商品類別</option>
                    <option v-else disabled value="">請選擇商品</option>
